...
<img src="https://render.githubusercontent.com/render/math?math=\t={c_x \hspace{1mm} c_y \hspace{1mm} c_z \hspace{1mm} n_x \hspace{1mm} n_y \hspace{1mm} n_z \hspace{1mm} r}">
